...
class seq_data(Dataset):
    ...
    def __getitem__(self, idx):
        x = self.traj[:-self.shift][idx*self.seq_length:(idx+1)*self.seq_length-1] # removed last point
        y = self.traj[self.shift:][idx*self.seq_length:(idx+1)*self.seq_length-1]  # removed last point
        return x, y
...
def predict(i):
    ...
    prediction=generate_text_FB( np.array([4]), 399 )
...
# Read data
# ----------------------------------------------- #
infile = '../../DATA/Train/ops/binned_z2_kappa1_3_0.npy'
